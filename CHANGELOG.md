...
* Generalize the CSV template system such that any attribute from run profiles and samples can be inserted. Extract the hard-coded logic into its own setup-function. This is how it always was intended to work.
